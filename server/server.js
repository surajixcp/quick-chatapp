...
export const io = new Server(server, {
    cors: {
        origin: ["http://localhost:5173", "https://chat-web-bice-omega.vercel.app", "https://chat-web-git-main-surajixcps-projects.vercel.app", "https://quick-chatapp-pui3.vercel.app"],
        methods: ["GET", "POST"],
        credentials: true,
    }
})
