  ...
  return (
    <div className='min-h-screen flex items-center justify-center p-6 sm:p-12 relative'>
      ...
      <div className="flex items-center justify-center gap-10 lg:gap-32 max-lg:flex-col w-full z-10">
        ...
        {/* ------------right--------------- */}
        <form onSubmit={onSubmitHandler} className='w-full max-w-[420px] bg-black/20 backdrop-blur-3xl text-white border border-white/10 p-8 sm:p-10 flex flex-col gap-5 rounded-[2.5rem] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)] animate-fade-in-up'>
